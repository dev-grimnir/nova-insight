// src/controllers/nova-crypto-controller.js
// NovaCryptoController — STATIC controller responsible for ALL encryption/decryption logic
//
// Why static?
...
//
// Every console.log is prefixed with [NovaCryptoController.methodName]
// so you can instantly see exactly where each message comes from.

class NovaCryptoController {
    ...
    static async #loadRememberedMasterKey() {
        ...
        try {
            ...
            console.warn("[NovaCryptoController.#loadRememberedMasterKey] failed to load remembered key — clearing it");
    ...
    // =================================================================
    // PUBLIC API — called by NovaDashboardController and NovaPassphraseController
    // =================================================================

    /**
     * Initializes the master encryption key.
     * 
     * Called once from NovaDashboardController.initAsync() during startup.
     * 
     * Behavior:
    ...
    static async initMasterKey() {
        ...
        /**
     * Simple getter so NovaDashboardController knows whether it needs to show the passphrase modal.
     * 
     * Called from:
     *   - NovaDashboardController.initAsync()
     * 
     ...
     * 
     * Called from:
     *   - NovaPassphraseController.handleSubmit()
     * 
