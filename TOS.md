...
- Use the service for any purpose other than receiving authorized diagnostic messages
- Attempt to send messages through the system
- Reverse engineer, modify, or interfere with the service
- Share access credentials or allow unauthorized users to receive messages
